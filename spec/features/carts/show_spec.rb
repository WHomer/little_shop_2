...
RSpec.describe 'As a visitor' do
  ...
  describe 'when i have items in my card' do
    before :each do
      ...
      buyer_1 = create(:user)
      add_1 = buyer_1.user_addresses.create!(nickname: "nickname_1", street_address_1: "street number 1", street_address_2: "apt 1", city: 'city 1', state_province: 'state 1', zip_code: '123123', phone_number: 'phone 1' )
      buyer_2 = create(:user)
      add_2 = buyer_2.user_addresses.create!(nickname: "nickname_1", street_address_1: "street number 1", street_address_2: "apt 1", city: 'city 1', state_province: 'state 1', zip_code: '123123', phone_number: 'phone 1' )
      buyer_3 = create(:user)
      add_3 = buyer_3.user_addresses.create!(nickname: "nickname_1", street_address_1: "street number 1", street_address_2: "apt 1", city: 'city 1', state_province: 'state 1', zip_code: '123123', phone_number: 'phone 1' )
      buyer_4 = create(:user)
      add_4 = buyer_4.user_addresses.create!(nickname: "nickname_1", street_address_1: "street number 1", street_address_2: "apt 1", city: 'city 1', state_province: 'state 1', zip_code: '123123', phone_number: 'phone 1' )
      order_1 = create(:order, user: buyer_1, user_address: add_1)
      order_2 = create(:order, user: buyer_1, user_address: add_1)
      order_3 = create(:order, user: buyer_2, user_address: add_2)
      order_4 = create(:order, user: buyer_2, user_address: add_2)
      order_5 = create(:order, user: buyer_3, user_address: add_3)
      order_6 = create(:order, user: buyer_3, user_address: add_3)
      order_7 = create(:order, user: buyer_3, user_address: add_3)
      order_8 = create(:order, user: buyer_2, user_address: add_2)
      order_9 = create(:order, user: buyer_1, user_address: add_1)
      order_10 = create(:order, user: buyer_3, user_address: add_3)
      order_11 = create(:order, user: buyer_4, user_address: add_4)
