...
buyer_1 = User.create!(email: 'buyer1@gmail.com', password: 'password', active: true, name: 'Jason Lovescheese')
buyer_1.user_addresses.create!(nickname: "nickname_1", street_address_1: "street number 1", street_address_2: "apt 1", city: 'city 1', state_province: 'state 1', zip_code: '123123', phone_number: 'phone 1' )
buyer_2 = User.create!(email: 'buyer2@gmail.com', password: 'password', active: true, name: 'Christina Grater')
...
buyer_3 = User.create!(email: 'buyer3@gmail.com', password: 'password', active: true, name: 'Jack Pepper')
...
buyer_4 = User.create!(email: 'buyer4@gmail.com', password: 'password', active: true, name: 'Jason Munster')
...
buyer_5 = User.create!(email: 'buyer5@gmail.com', password: 'password', active: true, name: 'Linda Begood')
buyer_5.user_addresses.create!(nickname: "nickname_1", street_address_1: "street number 1", street_address_2: "apt 1", city: 'city 1', state_province: 'state 1', zip_code: '123123', phone_number: 'phone 1' )

order_1 = Order.create!(user: buyer_1, status: 2, updated_at: DateTime.now + 10, user_address_id: buyer_1.user_addresses.first.id)
order_2 = Order.create!(user: buyer_2, status: 2, updated_at: DateTime.now + 20, user_address_id: buyer_2.user_addresses.first.id)
order_3 = Order.create!(user: buyer_3, status: 2, updated_at: DateTime.now + 30, user_address_id: buyer_3.user_addresses.first.id)
order_4 = Order.create!(user: buyer_4, status: 2, updated_at: DateTime.now + 40, user_address_id: buyer_4.user_addresses.first.id)
order_5 = Order.create!(user: buyer_5, status: 2, updated_at: DateTime.now + 50, user_address_id: buyer_5.user_addresses.first.id)
order_6 = Order.create!(user: buyer_1, status: 2, updated_at: DateTime.now + 60, user_address_id: buyer_1.user_addresses.first.id)
order_7 = Order.create!(user: buyer_2, status: 2, updated_at: DateTime.now + 70, user_address_id: buyer_2.user_addresses.first.id)
order_8 = Order.create!(user: buyer_3, status: 2, updated_at: DateTime.now + 70, user_address_id: buyer_3.user_addresses.first.id)

order_item_1 = OrderItem.create!(item: gouda, order: order_1, quantity: 12, price: gouda.price, fulfilled: true, updated_at: DateTime.now + 40)
order_item_2 = OrderItem.create!(item: brie, order: order_2, quantity: 2, price: brie.price, fulfilled: true, updated_at: DateTime.now + 10)
order_item_3 = OrderItem.create!(item: asiago, order: order_3, quantity: 3, price: asiago.price, fulfilled: true, updated_at: DateTime.now + 30)
order_item_4 = OrderItem.create!(item: cheddar, order: order_4, quantity: 4, price: cheddar.price, fulfilled: true, updated_at: DateTime.now + 20)
order_item_5 = OrderItem.create!(item: roquefort, order: order_5, quantity: 5, price: roquefort.price, fulfilled: true, updated_at: DateTime.now + 400)
order_item_6 = OrderItem.create!(item: pepperjack, order: order_6, quantity: 6, price: havarti.price, fulfilled: true, updated_at: DateTime.now + 300)
order_item_7 = OrderItem.create!(item: mozarella, order: order_7, quantity: 2, price: mozarella.price, fulfilled: true, updated_at: DateTime.now + 20)
order_item_8 = OrderItem.create!(item: feta, order: order_1, quantity: 3, price: feta.price, fulfilled: true, updated_at: DateTime.now + 10)
order_item_9 = OrderItem.create!(item: goat, order: order_2, quantity: 4, price: goat.price, fulfilled: true, updated_at: DateTime.now + 10)
order_item_10 = OrderItem.create!(item: manchego, order: order_3, quantity: 9, price: manchego.price, fulfilled: true, updated_at: DateTime.now + 130)
order_item_11 = OrderItem.create!(item: provolone, order: order_4, quantity: 1, price: provolone.price, fulfilled: true, updated_at: DateTime.now + 60)
order_item_12 = OrderItem.create!(item: ricotta, order: order_5, quantity: 21, price: ricotta.price, fulfilled: true, updated_at: DateTime.now + 80)
order_item_13 = OrderItem.create!(item: gorgonzola, order: order_6, quantity: 3, price: gorgonzola.price, fulfilled: true, updated_at: DateTime.now + 20)
order_item_14 = OrderItem.create!(item: gruyere, order: order_7, quantity: 4, price: gruyere.price, fulfilled: true, updated_at: DateTime.now + 10)
order_item_15 = OrderItem.create!(item: camembert, order: order_1, quantity: 9, price: camembert.price, fulfilled: true, updated_at: DateTime.now + 80)
order_item_16 = OrderItem.create!(item: gouda, order: order_2, quantity: 21, price: gouda.price, fulfilled: true, updated_at: DateTime.now + 20)
order_item_17 = OrderItem.create!(item: brie, order: order_3, quantity: 4, price: brie.price, fulfilled: true, updated_at: DateTime.now + 10)
order_item_18 = OrderItem.create!(item: asiago, order: order_4, quantity: 1, price: asiago.price, fulfilled: true, updated_at: DateTime.now + 20)
order_item_19 = OrderItem.create!(item: cheddar, order: order_5, quantity: 2, price: cheddar.price, fulfilled: true, updated_at: DateTime.now + 10)
order_item_20 = OrderItem.create!(item: havarti, order: order_6, quantity: 87, price: havarti.price, fulfilled: true, updated_at: DateTime.now + 10)
order_item_21 = OrderItem.create!(item: mozarella, order: order_7, quantity: 23, price: mozarella.price, fulfilled: true, updated_at: DateTime.now + 10)
order_item_22 = OrderItem.create!(item: feta, order: order_1, quantity: 1, price: feta.price, fulfilled: true, updated_at: DateTime.now + 40)
order_item_23 = OrderItem.create!(item: goat, order: order_2, quantity: 6, price: goat.price, fulfilled: true, updated_at: DateTime.now + 40)
order_item_24 = OrderItem.create!(item: manchego, order: order_3, quantity: 32, price: manchego.price, fulfilled: true, updated_at: DateTime.now + 30)
order_item_25 = OrderItem.create!(item: gouda, order: order_4, quantity: 1, price: gouda.price, fulfilled: true, updated_at: DateTime.now + 10)
order_item_26 = OrderItem.create!(item: swiss, order: order_8, quantity: 23, price: swiss.price, fulfilled: true, updated_at: DateTime.now + 20)
order_item_27 = OrderItem.create!(item: mascarpone, order: order_8, quantity: 44, price: mascarpone.price, fulfilled: true, updated_at: DateTime.now + 15)
order_item_28 = OrderItem.create!(item: parmigiano_reggiano, order: order_8, quantity: 44, price: parmigiano_reggiano.price, fulfilled: true, updated_at: DateTime.now + 10)
order_item_29 = OrderItem.create!(item: muenster, order: order_7, quantity: 122, price: muenster.price, fulfilled: true, updated_at: DateTime.now + 70)
order_item_30 = OrderItem.create!(item: muenster, order: order_6, quantity: 122, price: muenster.price, fulfilled: true, updated_at: DateTime.now + 40)
order_item_31 = OrderItem.create!(item: parmigiano_reggiano, order: order_6, quantity: 44, price: parmigiano_reggiano.price, fulfilled: true, updated_at: DateTime.now + 20)
